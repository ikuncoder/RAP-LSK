...
public class MockMgrImpl implements MockMgr {
    ...
    public String  getDomainNameActionId(int actionId){
        return mockDao.getDomainNameActionId(actionId);
    }
    public String getPageIdByActionId(int actionId){
        return mockDao.getPageIdByActionId(actionId);
    }
    ...
    public int getPageIdBydDomainName(String domainName){
        return mockDao.getPageIdBydDomainName(domainName);
    }
    public String getDomainNameByPageId(int pageId) {
        return mockDao.getDomainNameByPageId(pageId);
    }
